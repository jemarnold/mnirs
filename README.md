...
distinct_list <- extract_intervals(
    ...
    start = by_time(193, 904),  ## manually identified interval start times
    end = by_time(373, 1084),   ## interval end time (start + 180 sec)
...
ensemble_list <- extract_intervals(
    ...
    start = by_time(193, 904),  ## alternatively specify start times + 180 sec
