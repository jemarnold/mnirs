...
Near-infrared spectroscopy (NIRS) is a non-invasive optical technology used to evaluate the dynamic balance of local oxygen (O<sub>2</sub>) delivery and extraction in vivo within biological tissue. NIRS has been used in human biology research for nearly half a century looking predominantly at cerebral (functional; fNIRS) and muscle (mNIRS) tissues {Jobsis, 1977}. In recent years, the emergence of commercial wearable mNIRS devices has rapidly expanded use outside of advanced research laboratory environments, and facilitated the ease of data collection in field conditions for more diverse real-world applications in exercise physiology, sport science, clinical applications, and high performance sport {Grassi, 2016; Perrey, 2024; Jan, 2026}.

Today, wearable  mNIRS devices are relatively affordable, and valid and reliable for field use {Yogev, 2023}. 
